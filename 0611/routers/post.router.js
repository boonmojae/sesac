...
router.get("/:postId", getPostValidator, handleValidationResult, postController.findByPost);
//특정 게시글 조회
...
//분리
router.post("/", authenticateToken, postValidator, handleValidationResult, postController.create)
//게시글 생성_로그인 된 사람만
